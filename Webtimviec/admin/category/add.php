			...
			<div class="panel-body">
				<form method="post">
					...
					<div class="form-group">
					  ...
					  <input required="true" type="text" class="form-control" id="job_name" name="job_name">
					</div>
					<div class="form-group">
					  <label for="job_quantity">Số lượng tuyển dụng:</label>
					  <input type="text" class="form-control" id="job_quantity" name="job_quantity">
					</div>
					<div class="form-group">
					  <label for="job_salary">Mức lương:</label>
					  <input required="true" type="text" class="form-control" id="job_salary" name="job_salary">
					</div>
					<div class="form-group">
					  <label for="job_language">Yêu cầu về ngôn ngữ:</label>
					  <input required="true" type="text" class="form-control" id="job_language" name="job_language">
					</div>
					<div class="form-group">
					<label for="job_experiment">Yêu cầu về kinh nghiệm:</label>
					  <input required="true" type="text" class="form-control" id="job_experiment" name="job_experiment">
					</div>
					<div class="form-group">
					<label for="job_environment">Môi trường làm việc:</label>
					  <input required="true" type="text" class="form-control" id="job_environment" name="job_environment">
					</div>
					<div class="form-group">
					<label for="job_profit">Phúc lợi:</label>
					  <input required="true" type="text" class="form-control" id="job_profit" name="job_profit">
					</div>
					<div class="form-group">
					<label for="job_address">Địa chỉ:</label>
					  <input required="true" type="text" class="form-control" id="job_address" name="job_address">
					</div>
					<div class="form-group">
					<label for="job_hotline">Số điện thoại:</label>
					  <input required="true" type="text" class="form-control" id="job_hotline" name="job_hotline">
					</div>
					<div class="form-group">
					<label for="job_email">Địa chỉ Email:</label>
					  <input required="true" type="text" class="form-control" id="job_email" name="job_email">
					</div>
					<div class="form-group">
					<label for="job_start">Thời hạn bắt đầu tuyển:</label>
					  <input required="true" type="text" class="form-control" id="job_start" name="job_start">
					</div>
					<div class="form-group">
					<label for="job_end">Thời hạn kết thúc tuyển:</label>
					  <input style="margin-bottom:40px" required="true" type="text" class="form-control" id="job_end" name="job_end">
					</div>
