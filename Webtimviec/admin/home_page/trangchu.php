...
<body>
	...
	<div class="menu"> <!-- THANH MENU START -->
		<nav class="navbar navbar-expand-sm">
			...
			<form class="form-inline" action="name_seaching.php" method="post">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Tìm kiếm tên công việc">
					<div class="input-group-prepend">
						<span style="background-color: white;" class="input-group-text"><a style="color:black" href="name_seaching.php"><i style="border: none" class="fas fa-search"></i></a></span>
					</div>
				</div>
			</form>
		</nav>
