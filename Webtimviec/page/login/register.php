...
<section class="login-block">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1" class="text">Tên Người Dùng</label>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1" class="text">Ngày sinh</label>
    <input type="text" class="form-control" placeholder="" name='txtBirthday'>
  </div>
  <div class="form-group">
